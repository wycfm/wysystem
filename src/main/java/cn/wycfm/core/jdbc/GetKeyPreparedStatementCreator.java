...
public class GetKeyPreparedStatementCreator implements PreparedStatementCreator, SqlProvider{
	...
	public GetKeyPreparedStatementCreator() {};
	
	

	public GetKeyPreparedStatementCreator(String sql, Object[] args, int[] argTypes) {
		this.sql = sql;
		this.args = args;
